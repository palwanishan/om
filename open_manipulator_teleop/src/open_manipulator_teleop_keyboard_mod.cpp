...
void OpenManipulatorTeleop::setGoal(char ch)
{
  ...
  else if (ch == '5')
  {
    ...
    joint_name.push_back("joint2"); joint_angle.push_back(0.245);
    joint_name.push_back("joint3"); joint_angle.push_back(0.377);
    joint_name.push_back("joint4"); joint_angle.push_back(-0.70);
    joint_name.push_back("joint5"); joint_angle.push_back(0.0);
    joint_name.push_back("joint6"); joint_angle.push_back(0.0);
    setJointSpacePath(joint_name, joint_angle, path_time);
  ...
  else if (ch == '6')
  {
    ...
    joint_name.push_back("joint1"); joint_angle.push_back(-1.57);
    joint_name.push_back("joint2"); joint_angle.push_back(0.87);
  ...
  else if (ch == '7')
  {
    ...
    std::vector<double> joint_angle;
    double path_time = 2.0;
    joint_name.push_back("joint1"); joint_angle.push_back(0.3);
    joint_name.push_back("joint2"); joint_angle.push_back(1.8);
    joint_name.push_back("joint3"); joint_angle.push_back(-0.2);
    joint_name.push_back("joint4"); joint_angle.push_back(-1.7);
    joint_name.push_back("joint5"); joint_angle.push_back(0.0);
    joint_name.push_back("joint6"); joint_angle.push_back(1.0);
    setJointSpacePath(joint_name, joint_angle, path_time);
  }
  else if (ch == '9')
  {
    ...
    double path_time = 2.0;
    joint_name.push_back("joint1"); joint_angle.push_back(0.0);
    joint_name.push_back("joint2"); joint_angle.push_back(1.1);
