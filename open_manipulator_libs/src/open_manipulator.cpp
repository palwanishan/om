...
void OpenManipulator::initOpenManipulator(bool using_actual_robot_state, STRING usb_port, STRING baud_rate, float control_loop_time)
{
  ...
  *****************************************************************************/
  ...
  addJoint("joint1",  // my name
           "world",   // parent name
           "joint2",  // child name
            math::vector3(0.0, 0.0, 0.036),                // relative position
  ...
  addJoint("joint2",  // my name
            "joint1",  // parent name
            "joint3",  // child name
            math::vector3(0.0, 0.0, 0.05675),                // relative position
            math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
            Y_AXIS,    // axis of rotation
            22,        // actuator id
            2.05,    // max joint limit (1.67 rad)
  ...
  addJoint("joint3",  // my name
            "joint2",  // parent name
            "joint4",  // child name
            math::vector3(0.024, 0.0, 0.161714),               // relative position
            math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
            Y_AXIS,    // axis of rotation
            23,        // actuator id
  ...
  addJoint("joint4",  // my name
            "joint3",  // parent name
            "joint5", // child name
            math::vector3(0.1235, 0.0, 0.0),                 // relative position
            math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
            Y_AXIS,    // axis of rotation
            24,        // actuator id
  ...
  addTool("gripper",  // my name
          "joint6",   // parent name
          math::vector3(0.059, 0.0, 0.0),                 // relative position
          math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
          28,         // actuator id
          0.015,      // max gripper limit (0.01 m)
...
//  kinematics_ = new kinematics::SolverUsingCRAndSRPositionOnlyJacobian();
  ...
  if(using_actual_robot_state)
  {
    ...
    *****************************************************************************/
    ...
    jointDxlId.push_back(21);
    jointDxlId.push_back(22);
    jointDxlId.push_back(23);
    jointDxlId.push_back(24);
    jointDxlId.push_back(25);
    jointDxlId.push_back(26);
